...
function extractValue(arr, key) {
    return arr.reduce(function(accumulator, currentVal) {
        console.log(`currentVal is: ${JSON.stringify(currentVal)}`);
...
function vowelCount(str) {
    ...
    return strArr.reduce(function(acc, currVal) {
...
function addKeyAndValue(arr, key, value) {
    /*
    return arr.reduce(function(acc, currVal, idx) {
        acc[idx][key] = value;
        return acc;
    }, arr);
    */
    ...
    return arr.reduce(function(acc, currVal, idx) {
        ...
        //console.log(`currVal: ${JSON.stringify(currVal)}`)

        obj["name"] = currVal["name"];
        obj[key] = value;
        acc.push(JSON.stringify(obj));
        //console.log(`updates acc is: ${acc}`);
