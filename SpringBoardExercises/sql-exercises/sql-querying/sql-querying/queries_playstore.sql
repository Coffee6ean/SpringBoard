...
--    equal to 4.8.
    SELECT app_name,reviews,rating FROM analytics 
        WHERE rating > 4.8 LIMIT 1;

-- 6. Find the average rating for each category ordered by the highest 
...
-- 9. Find the names of all apps that are rated less than 3 with at least 
--    10000 reviews.
    SELECT app_name FROM analytics
        WHERE rating < 3 AND reviews >= 10000;

-- 10. Find the top 10 most-reviewed apps that cost between 10 cents and a
--     dollar.
    SELECT * FROM analytics
...
-- 11. Find the most out of date app. Hint: You don’t need to do it this 
...
--     Display the name of the app along with the number of reviews, the 
